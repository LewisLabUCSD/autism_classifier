...
source('/Volumes/Work/Vahid_work/classification_newcode/autism_classifier/8_supplmentary_code/Gsea.R')
# BiocManager::install("clusterProfiler")
setwd("/Volumes/Work/Vahid_work/classification_newcode/autism_classifier/8_supplmentary_code/")
...
DE_out_path <- "/Volumes/Work/Vahid_work/classification_newcode_data/final_result_plot/final_list/de_out/"
export_path <- "/Volumes/Work/Vahid_work/classification_newcode_data/final_result_plot/final_list/de_out_test/"
# IDmappingfile <- "mouse2human.txt" #"Data/zebrafish2human_idmapping.txt"
convert = F #FALSE
gene_name = TRUE 
GSEA_set = c('c0', 'c2', 'c3','c5')
minGSSize = 15 #20 #30
pAdjustMethod = "BH"
pvalueCutoff = 0.1
export = "BOTH"
